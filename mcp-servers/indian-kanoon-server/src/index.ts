...
interface DocumentFragmentParams {
	docId: string
	formInput: string
}

interface DocumentMetaParams {
	docId: string
}

const isValidSearchParams = (args: any): args is SearchParams =>
	typeof args === "object" &&
	args !== null &&
...
const isValidDocumentParams = (args: any): args is DocumentParams =>
	typeof args === "object" &&
	args !== null &&
...
const isValidDocumentFragmentParams = (args: any): args is DocumentFragmentParams =>
	typeof args === "object" && args !== null && typeof args.docId === "string" && typeof args.formInput === "string"

const isValidDocumentMetaParams = (args: any): args is DocumentMetaParams =>
	typeof args === "object" && args !== null && typeof args.docId === "string"
...
class IndianKanoonServer {
	...
	private async handleSearchCases(args: unknown) {
	...
	private async handleGetDocumentFragment(args: unknown) {
	...
	private async handleGetDocumentMeta(args: unknown) {
