...
// The Language Model API types are now included in @types/vscode for newer versions.
// This file maintains backward compatibility while leveraging the built-in types when available.
